    ...
    private static async Task AddProducts(AppDbContext context)
    {
        s_products = new List<Product>()
        {
            new Product
            {
                ...
                Price = 100,
                ImageName = "ecostore.com/images/soap.jpg",
                Stock = 100,
            ...
            new Product
            {
                ...
                Price = 500,
                ImageName = "ecostore.com/images/belt.jpg",
                Stock = 50,
            ...
            new Product
            {
                ...
                Price = 200,
                ImageName = "ecostore.com/images/bag.jpg",
                Stock = 200,
                CategoryId = s_categories[1].Id,
            ...
            new Product
            {
                ...
                Price = 300,
                ImageName = "ecostore.com/images/spoons.jpg",
                Stock = 150,
            ...
            new Product
            {
                ...
                Price = 50,
                ImageName = "ecostore.com/images/bags.jpg",
                Stock = 500,
                CategoryId = s_categories[0].Id,
            ...
            new Product
            {
                ...
                Price = 150,
                ImageName = "ecostore.com/images/shampoo.jpg",
                Stock = 80,
                CategoryId = s_categories[2].Id,
                BrandId = s_brands[1].Id,
            },
            new Product
            {
                ...
                Price = 100,
                ImageName = "ecostore.com/images/candle.jpg",
                Stock = 100,
                CategoryId = s_categories[0].Id,
                BrandId = s_brands[2].Id,
            },
            new Product
            {
                ...
                Price = 100,
                ImageName = "ecostore.com/images/toothpaste.jpg",
                Stock = 100,
                CategoryId = s_categories[2].Id,
                BrandId = s_brands[1].Id,
            },
            new Product
            {
                ...
                Price = 100,
                ImageName = "ecostore.com/images/dishwashing.jpg",
                Stock = 100,
                CategoryId = s_categories[2].Id,
                BrandId = s_brands[0].Id,
            },
            new Product
            {
                ...
                Price = 200,
                ImageName = "ecostore.com/images/bottle.jpg",
                Stock = 200,
                CategoryId = s_categories[0].Id,
                BrandId = s_brands[2].Id,
            }
